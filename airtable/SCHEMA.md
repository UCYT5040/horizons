...
| Horizons Admin Project Link | URL | Deep link to the project in the Horizons admin panel — `${FRONTEND_URL}/admin/projects/${projectId}`. Written on both create and edit. |
