...
export class ProjectsService {
  ...
  async createSubmission(
    ...
    // Hour gate: first ship requires ≥3h; a reship of an approved project
    // requires ≥3h beyond that approved submission's snapshotted hours. The
    // +3 only applies when the latest submission is approved — after a normal
